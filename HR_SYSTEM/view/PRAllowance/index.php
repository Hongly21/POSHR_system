...
<body>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php $code = $row['EmpCode'];
                                            ...
                                            echo $emprow['EmpName'];
                                            ?></td>
                                        <td><?php echo $row['AllowanceType']; ?></td>
    ...
    <script>
        function deleteCompanyc(code) {
            Swal.fire({
                title: 'Are you sure?',
                text: 'This will permanently delete the allowance record.',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '../../action/PRAllowance/delete.php',
                        method: 'GET',
                        data: {
                            Code: code
                        },
                        success: function(response) {
                            Swal.fire({
                                icon: 'success',
                                title: 'Deleted!',
                                text: 'The allowance has been removed.',
                        ...
                        error: function(xhr, status, error) {
                            Swal.fire({
                                icon: 'error',
                                title: 'Delete Failed',
                                text: 'Could not delete the allowance.',
                                footer: error
                            });
                        }
                    });
