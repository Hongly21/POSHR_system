                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="action-buttons">
                                        <a href="../../action//LeaveApproval/approve.php?id=<?php echo($row['ID']); ?>" class="btn btn-primary me-2"><i class="fas fa-edit me-2"></i>Approve</a>
                                        <a href="../../action//LeaveApproval/reject.php?id=<?php echo($row['ID']); ?>" class="btn btn-danger"><i class="fas fa-trash-alt me-2"></i>Reject</a>
                                    </td>
            ...
            $('.delete-btn').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = `../../action/LeaveRequest/delete.php?id=${encodeURIComponent(id)}`;
                    }
                });
            });
        });
