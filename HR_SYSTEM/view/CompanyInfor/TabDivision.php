...
<div class="container" style="margin-top: 15px; border: 0.4px solid #ccc;  padding: 20px; border-radius: 5px;">
    ...
    <table class="table" id="example2">
        <thead>
            <tr>
                <th>
                    <button type="button" class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target="#divisionModal">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td>
                        <button type="button" class="btn btn-sm btn-warning me-2 editButton2" data-bs-toggle="modal" data-bs-target="#DevisionupdateModal"
                            data-id="<?php echo $row['Code']; ?>"
                            data-name="<?php echo $row['Description']; ?>"
                            data-status="<?php echo $row['Status']; ?>">
                            <i class="fa fa-edit"></i>
                        </button>
                        <button class="btn btn-sm btn-danger" onclick="deleteCompanydv('<?php echo $row['Code']; ?>')"><i class="fa fa-trash"></i></button>
